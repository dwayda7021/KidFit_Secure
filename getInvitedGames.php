...
while($gameInstancesrow = $gameInstanceData->fetch_assoc())
{
	...
	if($userStatus=='Invited' || $userStatus=='ReadyToPlay')
	{
		// *** CheCK GAMe STATUS
...
/*
// *** GET GAME INSTANCES (NOT QUIT STATUS) Where SELF IS INVOLVED *********
$gameInstancesQuery = "SELECT * from userGameData where userID='$selfID' AND (userGameStatus ='Invited' OR userGameStatus ='ReadyToPlay')";
